...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setDemoChildCount(a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_demo_child_count, 12));
            setGridChildCount(a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_demo_grid_child_count, 3));
